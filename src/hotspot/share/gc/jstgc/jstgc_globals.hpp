...
#ifndef SHARE_GC_JSTGC_JSTGC_GLOBALS_HPP
#define SHARE_GC_JSTGC_JSTGC_GLOBALS_HPP
...
#define GC_JSTGC_FLAGS(develop,                                           \
                         ...
                         constraint)                                        \
                                                                            \
  product(size_t, JstgcPrintHeapSteps, 20, EXPERIMENTAL,                  \
          "Print heap occupancy stats with this number of steps. "          \
          "0 turns the printing off.")                                      \
          range(0, max_intx)                                                \
                                                                            \
  product(size_t, JstgcUpdateCountersStep, 1 * M, EXPERIMENTAL,           \
          ...
          range(1, max_intx)                                                \
                                                                            \
  product(size_t, JstgcMaxTLABSize, 4 * M, EXPERIMENTAL,                  \
          ...
          range(1, max_intx)                                                \
                                                                            \
  product(bool, JstgcElasticTLAB, true, EXPERIMENTAL,                     \
          ...
          "smaller TLABs until policy catches up.")                         \
                                                                            \
  product(bool, JstgcElasticTLABDecay, true, EXPERIMENTAL,                \
          ...
          "large burst.")                                                   \
                                                                            \
  product(double, JstgcTLABElasticity, 1.1, EXPERIMENTAL,                 \
          ...
          range(1.0, DBL_MAX)                                               \
                                                                            \
  product(size_t, JstgcTLABDecayTime, 1000, EXPERIMENTAL,                 \
          ...
          range(1, max_intx)                                                \
                                                                            \
  product(size_t, JstgcMinHeapExpand, 128 * M, EXPERIMENTAL,              \
          "Min expansion step for heap. Larger value improves performance " \
          "at the potential expense of memory waste.")                      \
          range(1, max_intx)

// end of GC_JSTGC_FLAGS

#endif // SHARE_GC_JSTGC_JSTGC_GLOBALS_HPP
