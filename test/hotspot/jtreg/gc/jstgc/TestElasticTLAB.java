 ...
 * @summary Jstgc is able to work with/without elastic TLABs
 * @library /test/lib
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:-JstgcElasticTLAB
 *                   gc.jstgc.TestElasticTLAB
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:JstgcTLABElasticity=1
 *                   gc.jstgc.TestElasticTLAB
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:JstgcTLABElasticity=1.1
 *                   gc.jstgc.TestElasticTLAB
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:JstgcTLABElasticity=2.0
 *                   gc.jstgc.TestElasticTLAB
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:JstgcTLABElasticity=100
 *                   gc.jstgc.TestElasticTLAB
 */
