 ...
 * @summary Jstgc is able to work with/without elastic TLABs decay
 * @library /test/lib
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:-JstgcElasticTLABDecay
 *                   gc.jstgc.TestElasticTLABDecay
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:+JstgcElasticTLABDecay -XX:JstgcTLABDecayTime=1
 *                   gc.jstgc.TestElasticTLABDecay
 *
 * @run main/othervm -Xmx256m
 *                   -XX:+UnlockExperimentalVMOptions -XX:+UseJstgcGC
 *                   -XX:+JstgcElasticTLAB -XX:+JstgcElasticTLABDecay -XX:JstgcTLABDecayTime=100
 *                   gc.jstgc.TestElasticTLABDecay
 */
