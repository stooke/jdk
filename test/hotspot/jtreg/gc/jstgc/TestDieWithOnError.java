 ...
 * @summary Jstgc GC should die on heap exhaustion with error handler attached
 * @library /test/lib
 * @run driver gc.jstgc.TestDieWithOnError
 */
...
public class TestDieWithOnError {
  ...
  static String ON_ERR_MSG = "Jstgc error handler message";
